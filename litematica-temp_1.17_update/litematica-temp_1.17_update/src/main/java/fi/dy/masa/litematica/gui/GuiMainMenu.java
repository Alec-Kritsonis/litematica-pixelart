...
public class GuiMainMenu extends GuiBase
{
    ...
    public void initGui()
    {
        ...
        this.createChangeMenuButton(x + width + 20, y, width, ButtonListenerChangeMenu.ButtonType.PIXEL_ART);
    ...
    public static class ButtonListenerChangeMenu implements IButtonActionListener
    {
        ...
        public void actionPerformedWithButton(ButtonBase button, int mouseButton)
        {
            ...
            switch (this.type)
            {
                case AREA_EDITOR:
                    ...
                    break;
                case PIXEL_ART:
                    gui = DataManager.getSelectionManager().getPixelGui();
                    break;
        ...
        public enum ButtonType
        {
            ...
            PIXEL_ART                   ("litematica.gui.button.change_menu.create_pixelart", ButtonIcons.PIXEL_ART),
