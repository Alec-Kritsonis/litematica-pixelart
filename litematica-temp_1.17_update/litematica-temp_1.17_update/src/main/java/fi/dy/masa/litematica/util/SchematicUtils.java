...
public class SchematicUtils
{
    ...
    public static boolean saveSchematic(boolean inMemoryOnly)
    {
        ...
        if (area != null)
        {
            ...
            {
                GuiSchematicSave gui = new GuiSchematicSave(false);
    ...
    public static boolean savePixelSchematic(boolean inMemoryOnly)
    {
        SelectionManager sm = DataManager.getSelectionManager();
        AreaSelection area = sm.getCurrentSelection();
        ...
        if (area != null)
        {
            ...
            {
                GuiSchematicSave gui = new GuiSchematicSave(true);
                gui.setParent(GuiUtils.getCurrentScreen());
                GuiBase.openGui(gui);
            }
