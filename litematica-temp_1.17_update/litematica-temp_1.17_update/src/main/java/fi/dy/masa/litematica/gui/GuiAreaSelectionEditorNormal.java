                                          ...
                                          implements ISelectionListener<String>
{
    ...
    protected GuiTextFieldGeneric textFieldImagePath;
    protected GuiTextFieldGeneric textFieldPalletPath;
    ...
    protected int createButton(int x, int y, int width, @Nullable Corner corner, ButtonListener.Type type)
    {
        ...
        else if ((type == ButtonListener.Type.CREATE_SCHEMATIC || type == ButtonListener.Type.CREATE_PIXELART) && projectsMode)
        {
        ...
        if ((type == ButtonListener.Type.CREATE_SCHEMATIC || type == ButtonListener.Type.CREATE_PIXELART) && projectsMode == false)
        {
    ...
    protected void renameImagePath()
    {
        String newPath = this.textFieldImagePath.getText();

        // if (DataManager.getSchematicProjectsManager().hasProjectOpen())
        // {
        //     this.selection.setImagePath(newPath);
        // }
        // else
        // {
        //     this.selection.setImagePath(newPath);
        ...
        //     {
        //         DataManager.getSelectionManager().renameImagePath(this.selectionId, newPath, this);
        //         this.selectionId = DataManager.getSelectionManager().getCurrentSelectionId();
        //     }
        // }
        this.selection.setImagePath(newPath);
    ...
    protected void renamePalletPath()
    {
        String newPath = this.textFieldPalletPath.getText();
        this.selection.setPalletPath(newPath);
    }
    ...
    protected static class ButtonListener implements IButtonActionListener
    {
        ...
        public void actionPerformedWithButton(ButtonBase button, int mouseButton)
        {
            ...
            switch (this.type)
            {
                ...
                case CREATE_PIXELART:
                    SchematicUtils.savePixelSchematic(GuiBase.isShiftDown());
                    break;
                ...
                case SET_IMAGE_PATH:
                {
                    this.parent.renameImagePath();
                    break;
                }

                case SET_PALLET_PATH:
                {
                    this.parent.renamePalletPath();
                    break;
                }
        ...
        public enum Type
        {
            ...
            SET_IMAGE_PATH          ("litematica.gui.button.area_editor.set_image_path"),
            SET_PALLET_PATH         ("litematica.gui.button.area_editor.set_pallet_path"),
            ...
            CREATE_PIXELART         ("litematica.gui.button.area_editor.create_pixelart"),
