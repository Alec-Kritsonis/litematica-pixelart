...
public class AreaSelection
{
    ...
    protected String imagePath = "Unnamed";
    protected String palletPath = "Unnamed";
    ...
    public void setPalletPath(String path)
    {
        this.palletPath = path;
    }

    public String getPalletPath()
    {
        return this.palletPath;
    }
